...
// GET route for fetching a lesson by ID
...
app.post('/orders', async (req, res) => {
  ...
  // Update the stock of each lesson in the order
...
// GET route to test the search query
...
// GET route to get images from the static folder
app.get('/images/:imageName', (req, res) => {
  const { imageName } = req.params;
  res.sendFile(path.join(__dirname, `images/${imageName}`));
});

// PUT route for updating lesson spaces
